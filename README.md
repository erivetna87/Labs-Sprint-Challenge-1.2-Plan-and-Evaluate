...
- **Our first release canvas involves detection of text & images that are inappopriate for our product and user base. Curse words and graphic images will be detected and filtered from being pushed to pubicly accessed parts of the app. The completion of the release canvas will help make the app more marketable as it gives parents assurance that their children will not be exposed to unwanted images or words. 
...
-**See above
    ...
    We will test these features by performing testing of models with various images to ensure the accuracy of detection is large enough to fitler a majority of unsavory content. 
